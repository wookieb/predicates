...
* `npm test`
* `npm run lint` --> there should be no errors
* `npm run coverage` and inspect `coverage.html` to ensure it still has 100% coverage
* eventually, `npm run docs` and send a PR
